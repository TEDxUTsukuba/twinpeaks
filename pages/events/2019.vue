...
<script>
    ...
    import TalkDetails from '~/components/TalkDetails.vue'
      ...
      data(){
        return {
          speakers: [
            ...
            { id:3, title: "私は靴を履かないバーテンダー", name: "Leonid Dimaano / Annet Nakkazi", url: '/_nuxt/assets/speakers/2019/sp_2019_3-1.jpg' },
