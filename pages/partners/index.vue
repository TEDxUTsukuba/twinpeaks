<template>
  <section id="wrapper-dark">
    ...
    <section class="section">
      ...
      <div class="columns is-multiline is-mobile">
        <div class="column is-4-tablet is-6-mobile" v-for="(partner, index) in partners.filter(el => el.tier === '1')"
          ...
          <div class="nmp-dark has-text-centered">
            ...
            <div class="is-inline-block has-text-centered mb-2 has-background-primary"
              v-if="partner.instagram || partner.facebook || partner.twitter">
              <a v-if="partner.instagram" :href="partner.instagram" target="_blank" rel="noopener noreferrer"><i
                  class="mdi mdi-instagram has-text-white is-size-4" /></a>
              <a v-if="partner.facebook" :href="partner.facebook" target="_blank" rel="noopener noreferrer"><i
                  class="mdi mdi-facebook has-text-white is-size-4" /></a>
              <a v-if="partner.twitter" :href="partner.twitter" target="_blank" rel="noopener noreferrer"><i
                  class="mdi mdi-twitter has-text-white is-size-4" /></a>
            </div>
          </div>
        </div>
      </div>
      <!-- Tier 2 -->
      <div class="columns is-multiline is-mobile">
        <div class="column is-3-tablet is-6-mobile" v-for="(partner, index) in partners.filter(el => el.tier === '2')"
          :key="index">
          <div class="nmp-dark has-text-centered">
            <figure class="image is-1by1 my-5" v-if="partner.logo">
              <img :src="partner.logo.url" :alt="partner.name">
      ...
      <!-- Tier 3 -->
      <div class="columns is-multiline is-mobile">
        <div class="column is-2-tablet is-6-mobile" v-for="(partner, index) in partners.filter(el => el.tier === '3')"
          :key="index">
          <div class="nmp-dark has-text-centered">
            <figure class="image is-1by1 my-5" v-if="partner.logo">
              <img :src="partner.logo.url" :alt="partner.name">
