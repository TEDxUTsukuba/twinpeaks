<template>
  <section id="wrapper-dark">
    <section class="section has-text-centered is-halfheight">
      ...
      <h1 class="title is-1 is-spaced">{{ $t("partners.conference.title") }}</h1>
      <h1 class="subtitle has-text-grey-light">
        {{ $t("partners.conference.subtitle") }}
      </h1>
    </section>
...
export default {
  ...
  data() {
    return {
      ...
      meta: {
        title: this.$i18n.t("partners.conference.title"),
        description: this.$i18n.t("partners.conference.subtitle"),
