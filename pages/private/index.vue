      ...
      <div class="hero-body">
        <section class="section">
          <h2 class="title is-3">お役立ちリンク集</h2>
            <h3 class="title is-4">規約・ガイドライン (対象: 全員)</h3>
