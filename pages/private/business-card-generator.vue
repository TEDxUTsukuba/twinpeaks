<template>
  <div class="has-background-white has-text-dark">
    <section class="section has-text-centered">
      <h1
        class="title is-0 has-text-centered"
        style="margin-bottom: 0; padding-bottom: 1.5rem;"
      >
        Type. Save. Share.
      </h1>
      <h1 class="subtitle is-size-4 has-text-weight-light">
        Create your own
        <span class="has-text-weight-bold">digital</span> business card.
      </h1>
      <div class="columns is-multiline is-variable is-6">
        <div class="column is-5-desktop is-12-tablet">
          <div
            class="nmp-card-light"
            style="max-width: 480px; margin: 1rem auto 1rem auto;"
          >
            <b-field
              label="Name"
          ...
          <div
            ...
            style="max-width: 480px; margin: 1rem auto 1rem auto;"
          >
            <b-field label="Position" position="is-centered">
              <b-input
                expanded
                id="input"
                size="is-medium"
          ...
          <div
            class="nmp-card-light"
            style="max-width: 480px; margin: 1rem auto 2rem auto;"
          >
            <b-field label="Email" position="is-centered">
              <b-checkbox v-model="insertEmail"
                >contact&#64;tedxutsukuba.com</b-checkbox
              >
            </b-field>
        ...
        <div class="column is-7-desktop is-12-tablet">
          ...
          <p class="has-text-grey-light" style="margin: 2rem 0 1rem 0;">
    ...
    <footer class="has-text-centered" style="padding: 1rem;">
      <div class="content has-text-centered">
        <p class="has-text-grey-light">
          TEDxUTsukuba Digital Business Card Generator<br /><span
        ...
        <p class="has-text-grey" style="margin-bottom: 1rem;">
          <span class=""
            >Made with &#9829; by
            <nuxt-link to="./about/harry" class="has-text-weight-bold"
              >Harry</nuxt-link
            ></span
          >
        </p>
  ...
  methods: {
    save() {
      ...
      localStorage.setItem(
        this.inputName.replace(/ /g, "_") + "_from_TEDxUTsukuba",
  ...
  mounted() {
    ...
    if (!this.$ua.isFromPc())
      this.$buefy.notification.open({
        message:
          "This generator does not fully comparative with mobile browsers. Try using on your PCs. ",
        type: "is-warning",
