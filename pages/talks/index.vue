    ...
    <section class="section-wide">
      <div class="columns is-multiline">
        <div
          ...
          v-for="(talk, index) in talks.filter(
            el => el.youtubeId && !el.eventName.name.match('Live')
          )"
          :key="index"
              ...
              <div class="media">
                <div class="media-content">
                  ...
                  <h1 class="subtitle is-5" v-if="$i18n.locale == 'en'">
                    {{ talk.firstName }} {{ talk.middleName }}
                    {{ talk.lastName }}
                  </h1>
                  <h1 class="subtitle is-5" v-else>
                    {{ talk.lastName }} {{ talk.middleName }}
                    {{ talk.firstName }}
                  </h1>
                </div>
              </div>
                ...
                >
                  ...
                  >
                    <p
                      ...
                      v-if="!props.open && $i18n.locale == 'ja'"
                    >
                      {{ talk.description | substrBefore(75) }}…
                    </p>
                    <p
                      class="is-size-7 has-text-grey-light"
                      v-if="!props.open && $i18n.locale == 'en'"
                    >
                      {{ talk.description | substrBefore(75) }}…
                    </p>
                    <p
                    ...
                    <br />
                    <b-button
                      class="button is-gradient is-rounded is-outlined is-small"
