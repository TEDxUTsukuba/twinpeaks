    ...
    <!-- <div class="columns is-mobile"> -->
            ...
            <div class="columns is-multiline is-centered">
              ...
              <div class="column is-7-widescreen is-full-desktop is-full-tablet is-full-mobile">
                <div class="nmp-card-red">
                  ...
                  <hr>
                  <article class="is-size-6 has-text-grey-lighter">
                    {{ $t('intro.description') }}
                  </article>
                  <br>
      ...
      <!-- <section class="section">
          <h1 class="title is-1 is-0 has-text-centered">
            <span class="highlighter">Featured Talks</span>
          </h1>
          <div class="columns is-multiline">
            <card
              title="天才になる呪い"
              speaker="山田玲司"
              image_url="/_nuxt/assets/speakers/2019/sp_2019_3-1.jpg"
            >
            ...
            <card
              ...
              speaker="松島壮志"
              image_url="/_nuxt/assets/speakers/2019/sp_2019_1.jpg"
            >
              2020 / Personal growth
            </card>
            <card
              title="数学とコンピュータの融合による新しい折り紙の世界"
              speaker="三谷純"
              image_url="/_nuxt/assets/speakers/2019/sp_2019_1.jpg"
            >
              2017 / Science
        ...
        <section class="section">
            ...
            <div class="content has-text-white">
              <b-collapse :open="false" position="is-bottom" aria-id="contentIdForA11y1">
                <a class="button is-white is-rounded is-outlined" slot="trigger" slot-scope="props" aria-controls="contentIdForA11y1">
                    <b-icon :icon="!props.open ? 'menu-down' : 'menu-up'"></b-icon>
                    {{ !props.open ? 'Read more' : 'Read less' }}
                </a>
                <p>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                    Nulla accumsan, metus ultrices eleifend gravida, nulla nunc varius lectus, nec rutrum justo nibh eu lectus. Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                    Nulla accumsan, metus ultrices eleifend gravida, nulla nunc varius lectus, nec rutrum justo nibh eu lectus.
                </p>
                <h3 class="has-text-white">{{ $t('covid19-info.event.title') }}</h3>
                <p>{{ $t('covid19-info.event.description') }}</p>
                <h3 class="has-text-white">{{ $t('covid19-info.activity.title') }}</h3>
                <p>
                    Ut vulputate semper dui. Fusce erat odio, sollicitudin vel erat vel, interdum mattis neque.
                </p>
                <h3 class="has-text-white">See also</h3>
...
<style lang="scss" scoped>
  ...
  .svg_text path {
    ...
    stroke-dashoffset: 0;
    animation: path 6s infinite ease-in forwards;
  }
  @keyframes path {
    0% {
      fill: transparent;
